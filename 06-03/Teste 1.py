...
# Função para registrar os resultados no arquivo CSV
def registrar_resultado():
    ...
    with open('resultados_liga_portuguesa_2025.csv', 'a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([data_jogo, time1, time2, gols_time1, gols_time2, vencedor])
